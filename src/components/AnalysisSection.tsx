      ...
      <div className="max-w-7xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-8">
          <h2 className="text-3xl md:text-4xl font-semibold" style={{ color: 'hsl(210, 20%, 93%)' }}>
            Phân Tích <em className="font-display italic text-accent">Crypto</em>
          </h2>
        ...
        {loading ? (
          <div className="flex items-center justify-center py-16">
            ...
            <span className="ml-2 text-sm" style={{ color: 'hsl(210, 20%, 65%)' }}>Đang tải dữ liệu...</span>
          </div>
        ) : !data ? (
          <p className="text-center py-12 text-sm" style={{ color: 'hsl(210, 20%, 65%)' }}>Không thể tải dữ liệu thị trường</p>
        ) : (
          <>
            {/* Global Stats */}
            <motion.div
            ...
            >
              ...
              <div className="px-4 py-2 border-t border-border/20 flex items-center justify-between">
                <span className="text-[10px] text-muted-foreground/50 font-mono">Nguồn: Binance · CoinGecko</span>
